...
urlpatterns = [
    ...
    path("create-project/", views.create_view),
    ...
    path("<int:project_id>/skills/add/", views.add_skill_view, name="add-skill"),
    path("<int:project_id>/skills/<int:skill_id>/remove/", views.remove_skill_view, name="remove-skill"),
    path("<int:project_id>/edit", views.edit_view, name="edit"),
    path("<int:project_id>/edit/", views.edit_view),
    path("<int:project_id>", views.detail_view, name="detail"),
    path("<int:project_id>/", views.detail_view),
]
